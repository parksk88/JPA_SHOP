...
public class OrderServiceTest {
		...
		public void 상품주문() throws Exception {
			...
			Assert.assertEquals("상품 주문시 상태는  ORDER", OrderStatus.ORDER, getOrder.getStatus()); //파라미터는 메세지, expected, 실제값
		...
		public void 상품주문_재고수량초과() throws Exception {
			...
			int orderCount = 11; //의도한대로 count다르면 초록색 성공이뜨고
												 //의도와 다르게 count가 같으면 아래 fail까지 도착하며 에러가뜬다.
